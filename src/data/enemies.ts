...
export const ENEMIES: Record<string, EnemyDefinition> = {
  ...
  goblin_brute: {
    id: 'goblin_brute', name: 'Goblin Brute', maxHp: 90,
    str: 14, def: 6, mag: 0, speed: 6, crit: 5, acc: 80, evasion: 3,
  ...
  skeleton_knight: {
    id: 'skeleton_knight', name: 'Skeleton Knight', maxHp: 160,
    str: 16, def: 14, mag: 0, speed: 7, crit: 8, acc: 88, evasion: 5,
  ...
  crypt_guardian: {
    id: 'crypt_guardian', name: 'Crypt Guardian', maxHp: 700,
    str: 22, def: 18, mag: 8, speed: 6, crit: 10, acc: 90, evasion: 5,
  ...
  drowned_saint: {
    id: 'drowned_saint', name: 'The Drowned Saint', maxHp: 900,
    str: 18, def: 14, mag: 20, speed: 8, crit: 8, acc: 92, evasion: 8,
